...
async function downscaleImage(file: File, maxDim = 2000): Promise<HTMLCanvasElement> {
...
export default function AddVocabularyPage() {
  ...
  const { recognize, progress, status, isReady, isInitializing, languages, changeLanguages } = useTesseractOcr();
    ...
    return (
      <div className="p-4 sm:p-6">
        <div className="w-full max-w-sm mx-auto space-y-4 mb-6">
            ...
            <Select value={languages} onValueChange={(v) => changeLanguages(v)}>
                <SelectTrigger className="w-full h-12 text-base">
                    <SelectValue placeholder="OCR-Sprache(n) wählen" />
                </SelectTrigger>
                <SelectContent>
                    <SelectItem value="pol+deu" className="text-base">Polnisch + Deutsch</SelectItem>
                    <SelectItem value="eng+deu" className="text-base">Englisch + Deutsch</SelectItem>
                    <SelectItem value="pol+eng+deu" className="text-base">Polnisch + Englisch + Deutsch</SelectItem>
                </SelectContent>
            </Select>
        </div>
